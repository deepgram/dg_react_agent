 ...
 */
export function createAudioBuffer(audioContext, data, sampleRate) {
    if (sampleRate === void 0) { sampleRate = 48000; }
    var audioDataView = new Int16Array(data);
    if (audioDataView.length === 0) {
        return undefined;
    }
    var buffer = audioContext.createBuffer(1, audioDataView.length, sampleRate);
 ...
 */
export function getBrowserOptimizedConfig() {
 ...
 */
export function createOptimizedAudioContext() {
    var config = getBrowserOptimizedConfig();
