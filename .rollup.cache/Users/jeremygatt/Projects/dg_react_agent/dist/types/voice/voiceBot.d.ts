 ...
 */
export declare enum BehindScenesEventType {
 ...
 */
export declare enum VoiceBotActionType {
...
export type VoiceBotAction = {
    ...
    payload: VoiceBotMessage;
} | {
    type: VoiceBotActionType.ADD_BEHIND_SCENES_EVENT;
    payload: BehindScenesEvent;
} | {
 ...
 */
export declare function isConversationMessage(voiceBotMessage: VoiceBotMessage): voiceBotMessage is ConversationMessage;
/**
 * Type guard for latency messages
 */
export declare function isLatencyMessage(voiceBotMessage: VoiceBotMessage): voiceBotMessage is LatencyMessage;
/**
 * Type guard for user messages
 */
export declare function isUserMessage(conversationMessage: ConversationMessage): conversationMessage is UserMessage;
/**
