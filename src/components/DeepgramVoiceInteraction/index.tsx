...
/**
 * Main DeepgramVoiceInteraction component
 * This is a pure wrapper component that sets up all the providers
 */
const DeepgramVoiceInteraction = forwardRef<
  DeepgramVoiceInteractionHandle,
  DeepgramVoiceInteractionProps
>((props, ref) => {
  const {
...
export default DeepgramVoiceInteraction; 